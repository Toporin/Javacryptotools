    ...
    public List<Asset> get_nft_list(String address) {
        ...
        try {
            ...
            String url = base_url
                    ...
                    + address
                    + "/balances_nft/";
            logger.info("JAVACRYPTOTOOLS: Covalent get_nft_list url: " + url);
            ...
            for (int i = 0; i < items.length(); i++) {
                ...
                JSONObject externalData = token.getJSONObject("externalData");
                ...
                logger.info("JAVACRYPTOTOOLS: Covalent get_nft_list : asset.contract" + asset.contract);
                try{
